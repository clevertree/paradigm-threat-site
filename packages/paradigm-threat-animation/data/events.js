...
export const planetaryConfigs = [
    ...
    },
    {
        ...
        description: "Earth, Venus, Mars, Mercury, Jupiter form a rotating circle (Saturn no longer visible). Moon orbits Earth once per month.",
    ...
    },
    {
        ...
        description: "Earth, Venus, Mars, Mercury, Jupiter form a rotating circle (nothing in center). Circle rotates 4×/year, orbits Sun once/year. Saturn not visible.",
