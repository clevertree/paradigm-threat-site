...
<PopImage {...require("./life_on_mars_rules_earth.png?w=800")}
          className="sm:max-w-[60rem] rounded-md m-auto"
          alt="Life on Mars Rules life on Earth"/>
...
<figure className={`${imageStyleRight} sm:max-w-sm`}>
  <iframe width="360" height="200" src="https://www.youtube.com/embed/FWp9TfS8ny4"
          title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowFullScreen
          className={`max-w-full m-auto hidden sm:block`}/>
  <iframe width="360" height="200" src="https://www.youtube.com/embed/9GyTNIh9Ffk"
          title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowFullScreen
...
<PopImage {...require("./mars_life4.jpg?w=300")}
  ...
  [- Nicola
  Tesla](https://teslauniverse.com/nikola-tesla/articles/tesla-sure-life-exists-other-planets-works-76-establish-his-belief)
</PopImage>
...
<PopImage priority {...require("../chronology/pyramids/history_pyramid_gates1.jpg?w=360")}
          ...
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
  Examples of Pyramid structures are found in Egyptian pyramids, Ziggurats in the Middle East, and temples in Southeast
  Asia
</PopImage>
...
<PopImage {...require("../predictive_programming/stargate.jpg?w=360")}
...
<PopImage priority {...require("../chronology/pyramids/history_pyramid_gates2.jpg?w=360")}
          ...
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
  The Bosnian pyramids have flattened tops, like Latin and South American pyramids, and are constructed with stone
  slabs.
...
The memories of Atlantis, the yellow/rainbow road,
and the concept of a *simulated deity* appearing within a temple
exchanging gifts for worship all appear in the play [Wizard of Oz](https://en.wikipedia.org/wiki/The_Wonderful_Wizard_of_Oz).
...
<PopImage {...require("../predictive_programming/marvin2.jpg?w=240")}
...
The Deep State may have planned to emerge into the public and reveal its presence on Earth and Mars
...
<PopImage {...require("../predictive_programming/mars_women.jpg?w=640")}
...
<PopImage {...require("../predictive_programming/mars_movies.jpg?w=360")}
...
[predictive programming](https://joyoffaith.com/predictive-programming.html) about
...
<PopImage {...require("../predictive_programming/marvin.jpg?w=400")}
          alt="Mars Map"
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
...
The same tactic is used by Christians who show their young children images of crucified adults.
...
<PopImage priority {...require("../predictive_programming/doom.jpg?w=360")}
...
<PopImage priority {...require("../predictive_programming/wotw.jpg?w=360")}
          alt="Predictive Programming: Mars Movies"
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
