...
<PopImage priority {...require("../chronology/saturn/earth_was_saturns_moon5.jpg?w=384")}
...
as a continent *nearly large as the Earth* (i.e. Mars) that appears at the destination point of a
...
<PopImage priority {...require("../chronology/saturn/earth_was_saturns_moon2.jpg?w=384")}
...
<PopImage {...require("../chronology/saturn/norse_yggdrasil.jpg?w=384")} alt="Nine Planets or Realms of the Yggdrasil"
          className={`[&>img]:rounded-md ${imageStyleRight}`}/>
...
re-written to include the Atlanteans as the *heroes* of all of human history.
...
<PopImage {...require("./wotw/wotw_album_cylinder.jpg?w=384")}
...
<PopImage {...require("./wotw_technology_heat_ray.jpg?w=480")}
...
It's important to note that in the WotW story, the Tripods are observed taking away the remains of
