...
result of telepaths on Mars being wiped out by the secondary discharge that occurred
during the MudFlood Energetic Event
which (possibly unintentionally) destroyed cities across the surface of Mars.
