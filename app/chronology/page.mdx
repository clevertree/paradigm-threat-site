...
export const metadata = {
  ...
  keywords: "Saturnian Cosmology Timeline, Human History Timeline, Atlantis, Tower of Babel, Noah's Ark, The Exodus, Deep State, Jews",
  openGraph: {
...
<PopImage {...require("./tartaria/tartarian_structures.jpg?w=384")}
  ...
  'Tartarian' Empire - which ruled over all continents between 12th and 18th centuries before its breakup in 1775.
</PopImage>
...
to the non-linear configuration dominated by Jupiter (Dark ages), and into its final orbit in modern times.
...
<figure className={`${imageStyleLeft} sm:max-w-sm`}>
  <video title="Planet Being Born"
         poster="https://paradigm-threat.s3.amazonaws.com/video/thumb/Planet+Being+Born.png"
         controls
         className="m-auto w-[384px] h-[384px]"
  >
...
<PopImage {...require("./saturn/plasma_discharge_recorded2.jpg?w=384")}
  ...
  but were difficult to see by those who lived above the equator.
</PopImage>
...
<PopImage {...require("./pyramids/wormhole.jpg?w=600")}
          alt="Egyptian Worm-Hole as depicted in egyptian mythology"
          className={`m-auto [&>img]:rounded-md`}>
</PopImage>
...
risen from the dead after 2.5 days, once again appears upon its coma-tail mountain (or throne). This "resurrection"
...
<figure className={`${imageStyleRight} sm:max-w-sm`}>
  <video title="Phantom Time Hypothesis"
         poster="https://paradigm-threat.s3.amazonaws.com/video/thumb/Phantom+Time+Hypothesis.png"
         controls
         className="m-auto w-[384px] h-[570px]"
  >
...
<PopImage {...require("./christ/hairy_mary.jpg?w=384")}
  ...
  from the Body and Soul exhibit in Italy.
  *"I went to see the exhibition "Body and Soul: Sculpture in Italy from Donatello to Michelangelo," and this was
  the first I had ever heard of the miraculous body hair of Mary Magdalene! I mean, what?
  I guess Christians already knew about this? That she's supposed to have lived in the desert until her clothes
  crumbled away, then her own body hair miraculously grew to clothe her? Why hasn't this found its way into a short
  story I've read? Did everyone just know this already?"*
...
<PopImage {...require("./christ/tomb_of_christ_and_brother.jpg?w=384")}
          alt="Painting by Tintoretto: The Descent from the Cross"
          className={`${imageStyleRight} [&>img]:rounded-md`}>
  Shingō is the location of what is purported to be the resting place of Jesus, the "Tomb of Christ" (Kirisuto no haka),
  and the residence of Jesus' descendants, the Sawaguchi family.
</PopImage>
...
war *against* giants, but such willing and revenging behavior was the direct result of the Crucifixion of Christ.
...
### 1380 C.E. Giants are defeated at the Battle of Kulikovo
...
<PopImage {...require("./apocalypse/black_death.jpg?w=384")}
          alt="Late 14th Century illustration from Tuscany: devils shoot down arrows to inflict horror upon a
  ...
  against disease. During the Black Death of 1347–52, for example, a flagellant revival occurred, although this was
  condemned by church authorities as it descended into anti-clerical violence.
</PopImage>
...
<figure className={`${imageStyleLeft} sm:max-w-sm`}>
  <video title="Predictive Programming for Children: Conan the Barbarian finds Star Metal"
         poster="https://paradigm-threat.s3.amazonaws.com/video/thumb/Predictive+Programming:+Conan+The+Adventurer+Star+Metal.png"
         controls
         className="m-auto w-[384px] h-[288px]"
  >
    <source
      src="https://paradigm-threat.s3.amazonaws.com/video/Predictive+Programming:+Conan+The+Adventurer+Star+Metal.mp4"
      type="video/mp4"/>
  </video>
  <figcaption>
...
<PopImage {...require("./tartaria/painting_samson_and_delilah_by_rubens.jpg?w=384")}
  ...
  geographical names also 'moved' here. And the entire story of Joan of Arc turned into an allegedly 'purely French'
  story. Furthermore, it turns out that the famous French marshal Gilles de Rais, Joan of Arc's legendary
  comrade-in-arms, is partially described in the Bible under the name of Samson, the famous hero and warrior. This
  congruence is a result of the stories of Joan of Arc and the biblical Deborah overlapping each other. Marshal
  Gilles de Rais, French national hero, faced the Inquisition court and was burnt at the stake in the town of Nante
 -one of the most infamous landmark cases 'on witchcraft'. All three storylines are directly connected with the
  activities of the Inquisition on the territory of France (in the Scaligerian geography).
</PopImage>
...
### 1453 C.E. Hundred Year's War ends
...
<PopImage {...require("./apocalypse/apocalypse_vasnetsov.jpg?w=384")}
  ...
  After this fight a single God, sovereign, imposes itself and begins the journey of the biblical Egyptian exodus, and
  that of Troy, according to the mythified ancient history.
</PopImage>
...
fully under the influence of the Deep State. The Hordian troops also attacked from Siberia by crossing the Bering
...
from the Inquisition. The real identity of Christopher Columbus
...
<PopImage {...require("./tartaria/painting_ottoman_invades_vienna_1683.jpg?w=384")} className
  ...
  was
  the liberal behavior of the Europeans of the XIII-XIV cc. which led to the mass infectious diseases. Including
  venereal
  ...
  Eventually
  the ideology of modern Islam grew out of it. Extremely severe and chaste.
</PopImage>
...
own [Controlled Opposition](/controlled_opposition) project known as the Protestant Reformation. During the
...
<PopImage {...require("./tartaria/galileo_facing_the_inquisition.jpg?w=384")}
  ...
  center of the world and the earth moves, and henceforth not to hold, teach, or defend it in any way whatsoever, either
...
<PopImage {...require("./christ/cathar_suppression.jpg?w=384")}
  ...
  *"We cannot. We have been reared in their midst. We have relatives among them and we see them living lives of
  perfection."*
</PopImage>
...
> familiar to us. A foreigner, a Jewess, infiltrates the court of the 'Persian' king ( **Nebuchadnezzar Ahasuerus**),
> becomes his wife or an 'intimate person'. As a result a son or a close relative of the king – the
...
calendar in defiance of the Rus-Horde's [Lunisolar](https://en.wikipedia.org/wiki/Lunisolar_calendar) calendar. 13
...
and August named after Augustus Caesar who was *also* a reflection of Christ. Most significantly, the Jesuits moved the Birthday of Christ 1053 years into the past to *zero year*.
...
To accomplish this, the chronology compiled by [Joseph Scaliger](http://scihi.org/scaliger-chronology/) was heavily
...
<PopImage {...require("./fomenko_timeline_1633_1725.gif?w=384")}
  ...
  Solomon in the form of the Order of Saint John the Baptist, with which the European colonizer project began.
</PopImage>
...
<PopImage {...require("./apocalypse/great_comet_of_1665.jpg?w=384")}
  ...
  house in Hamburg. He corresponded with Ismäel Boulliau (1605–1694) in Paris and Henry Oldenburg (1618–1677), secretary
  of the Royal Society in London about the 1664 comet. In 1668 he published a three-part work on both comets, his
  Theatrum cometicum. Part one contained his correspondence on the topic with other European astronomers. The second
  part consisted of criticism by other scholars of his cometary theories and his answers to his critics, whilst the
  third part contained his astrological interpretations, including his opinion that the Great Fire of London was a
  punishment from God announced by the 1664 comet.
...
## C.E. 1773 to 1775 - The Rebellion of Pugachev
...
## C.E. 1774-1814 The MudFlood and World Cataclysm
