...
<div className={`${imageStyleRight} text-justify text-xs italic [&>p]:mt-0 [&>p]:p-0`}>
  <iframe title="Planet Being Born" width="560" height="250"
...
with a "big bang" or incredible brightness. Therefore, a "Big Bang" indicates the moment of *rebirth* in the cyclical
lifecycle of each Solar System, rather than in the entire Universe. The Lifecycle is as follows:

1. The Sun converts light elements to heavy which fall to the center and combine into a
[Proto-planet](https://en.wikipedia.org/wiki/Protoplanet).
Eventually the proto-planet becomes too large and develops its own
[magnetic field](https://www.sciencedirect.com/topics/physics-and-astronomy/planetary-magnetic-field).
