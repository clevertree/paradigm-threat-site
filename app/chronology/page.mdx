...
from [2200](https://chronologia.org/en/shakespeare/foreword.html)
sources including [Joseph Scaliger](https://en.wikipedia.org/wiki/Joseph_Justus_Scaliger),
the [House of Romanov](https://en.wikipedia.org/wiki/House_of_Romanov),
...
[Maya-Kiche](https://en.wikipedia.org/wiki/Maya_peoples) etc.
His team revealed **duplicated** matching chronology spanning periods of hundreds or thousands of years, often with the
names and locations changed. In his [New Chronology](https://en.wikipedia.org/wiki/New_chronology_\(Fomenko\)) modern human history started less than a thousand years ago:
