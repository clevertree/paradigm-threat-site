...
after its own image, out of raw material like clay (see also [Golem](https://www.jmberlin.de/en/topic-golem)).
As the Golden Age approached, the 3 southern plasmoids took on different shapes, generating different animal energy
patterns until finally the plasmoids formed the
