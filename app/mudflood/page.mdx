...
Eventually _Reformation_ historians made the case that Latin was the root of all language.
...
<PopImage {...require("./../chronology/redacted.jpg?w=360")} alt="History was Redacted"
          className={`[&>img]:rounded-md ${imageStyleRight}`}>
  The Deep State is defined as a international cabal,
...
<PopImage {...require("./../chronology/saturn/cosmic_mountain.jpg?w=360")} alt="Saturnian Cosmology: Cosmic Mountain"
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
  The cosmic mountain celebrated around the world,
  seen as a pillar of fire and light rising along the world axis;
...
<PopImage {...require("./../controlled_opposition/flat_earth/flat_earth_controlled_opposition2.jpg?w=320")}
  ...
  Like other controlled opposition projects, Flat Earth Theory is a divide an conquer strategy designed to split
...
<PopImage {...require("./../chronology/tartaria/tartarian_structures.jpg?w=360")} alt="MudFlood Evidence: Tartaria"
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
Tartarian Neo-classic architecture found all over the world is evidence of a previous Empire.
</PopImage>
...
<PopImage {...require("./grand_canyon_criscross_lightning_scar.jpg?w=360")}
          ...
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
  Rivers can never cross each-other without joining together, yet cris-cross scaring is found in several places
...
It appears that whoever fired the D.E.W. at Earth either did not fully understand the risk, or did not care.
...
like Enders Game, Battlefield Earth, StarWars, Stargate, Scientology, War of the Worlds etc.,
...
employed use of large-scale D.E.W. on Mars that would become the instrument that reversed the victories of the rebellion,
...
[converted to indiginous languages](https://en.wikipedia.org/wiki/Revised_Version)
and redistributed the 19th century.
