...
<PopImage {...require("./../chronology/new_chronology_backside.jpg?w=384")}
...
<PopImage {...require("../chronology/reformation/extraordinary_black_book.jpg?w=384")}
...
<PopImage {...require("./1557_lycosthenes_rain_of_stones_meteorite.jpg?w=384")} alt="MudFlood Evidence: A deadly rain of stones"
          className={`[&>img]:rounded-md ${imageStyleRight}`}>
