...
for the Rebellion itself was the attempts by the Romanov-controlled state to disenfranchise Cossacks, serfs, and tribal communities via heavy taxation, forced labor, and restrictions on their way of life.

### Annihilation of the Giant Humans
...
against the authority of the Romanovs who had siezed control of the empire during the bloody Oprichnina.
He was, as the giants always were, the biggest threat to the Church and it's doctrine.
This was the 3rd major war between humans and Giants that I know of. 
The first was the Crusade of the early 12th century.
The 2nd was the battle of Kulikovo where the Giants of the Horde succumbed to the 'Marathon' canon technology of the 
...
### The devastation of the Mudflood Energetic Event

The Russian Rebellion was cataclysmic and devastating (Fomenko uses the word 'wreckage') because Pugachev 
...
The only entity capable of causing such destruction was the advanced human civilization living on Mars which had broken away after the Golden Age. Until the war of 1773, Human Martians had used cathodal churches and telepathy to play God on Earth,
perform espionage, and speak to religious leaders through 'visions of angels'. Through simple tricks, they managed to consolidate nearly all religious military orders of the Earth via treaties like Rex Bellator. The only demographic they could not consolidate were the human giants, partialy because they were difficult to defeat in battle, and partially because they historically rejected Monotheism.
...
across the bering straight (Trail of tears). After the relocation, the bering straight was destroyed by the same
cannon(s) that destroyed Siberia and America. 

### Cannoization of the Holy Texts

With the final destruction of all the physical locations of existing world religions, each religion was 'canonized' 
into the final form we know today. The word 'Canon' means both 'authority' and a large gun. 
This likely means that the authority to cannonize the books of the Bible was achieved by the firing of cannons in battle.

Please check back soon for more revisions to the MFEE theory :)
...
Latin Root, splintering its religious icons, and rebranding it as the “Holy” Roman Empire.
...
<PopImage
  {...require("./napoleon_defaced_sphinx.jpg?w=384")} className="rounded-md"
...
<PopImage {...require("./napoleon_in_burning_moscow_-_Adam_Albrecht_(1841).jpg?w=384")} alt="War of 1812"
          className={`[&>img]:rounded-md ${imageStyleLeft}`}/>
...
Most MudFlood researchers will place the event in the early 19th century when we find an abundance of photos of “reset
...
<PopImage {...require("./map_1812_war.jpg?w=384")} alt="MudFlood Evidence: World War of 1812"
          className={`[&>img]:rounded-md ${imageStyleRight}`}/>
...
<PopImage {...require("./map_1812_napoleon_defeat.jpg?w=384")} alt="MudFlood Evidence: Napoleon's Unexplainable Defeat"
          className={`[&>img]:rounded-md ${imageStyleLeft}`}/>
...
Tchaikovsky notoriously hated the 1812 Overture - likely resenting the Theonationalistic subject. Similar lyrics
...
<PopImage {...require("./napoleon_burning_of_washington_1812.jpg?w=384")}
...
24. Grand canyon's Appalachian Sand mystery.
