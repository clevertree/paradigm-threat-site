...
<PopImage {...require("./../mars/predictive_programming_marvin.jpg?w=360")} alt="Predictive Programming: Mars Media"
          className={`[&>img]:rounded-md ${imageStyleLeft}`}>
...
<PopImage {...require("./../controlled_opposition/flat_earth/flat_earth_controlled_opposition2.jpg?w=320")}
...
<PopImage {...require("./predictive_programming_simpsons_space_laser.jpg?w=360")}
...
<PopImage {...require("./../mars/predictive_programming_marvin.jpg?w=360")}
